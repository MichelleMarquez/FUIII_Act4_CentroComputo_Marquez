...
$sql="SELECT * FROM centro WHERE id='$id'";
    ...
    <body>
                <div class="container mt-5">
                    <form action="update.php" method="POST">
                                ...
                                <input type="text" class="form-control mb-3" name="numcontrol" placeholder="Numero de control" value="<?php echo $row['numcontrol']  ?>">
                                <input type="text" class="form-control mb-3" name="correo" placeholder="Correo electronico" value="<?php echo $row['correo']  ?>">
                                <input type="hidden" name="fechareg" value="<?php echo $row['fechareg']  ?>">
